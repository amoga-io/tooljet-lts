    ...
    helmet.contentSecurityPolicy({
      ...
      directives: {
        ...
        'script-src': [
          ...
          'https://static.amoga.io/js/babel.min.js',
          'https://static.amoga.io/js/react-dom.production.min.js',
          'https://static.amoga.io/js/react.production.min.js',
          'cdn.skypack.dev',
          'cdn.jsdelivr.net',
          'https://esm.sh',
